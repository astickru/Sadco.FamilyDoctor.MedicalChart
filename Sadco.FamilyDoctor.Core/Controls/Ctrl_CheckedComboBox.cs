...
{
    public class Ctrl_CheckedComboBox : ComboBox
    {
        public class Cl_BoxItem
        {
            private int val;
            public int Value {
                get { return val; }
            ...
            public Cl_BoxItem(string name, int val)
            {
                this.name = name;
                this.val = val;
            }
        ...
        /// </summary>
        internal class Cl_Dropdown : Form
        {
            ...
            internal class CustomCheckedListBox : CheckedListBox
            {
                ...
                protected override void OnKeyDown(KeyEventArgs e)
                {
                    ...
                    {
                        // Enact selection.
                        ((Ctrl_CheckedComboBox.Cl_Dropdown)Parent).OnDeactivate(new CCBoxEventArgs(null, true));
                        e.Handled = true;
                    ...
                    {
                        // Cancel selection.
                        ((Ctrl_CheckedComboBox.Cl_Dropdown)Parent).OnDeactivate(new CCBoxEventArgs(null, false));
                        e.Handled = true;
                ...
                protected override void OnDrawItem(DrawItemEventArgs e)
                {
                    ...
                    if (sep)
                    {
                        DrawItemEventArgs eNew = new DrawItemEventArgs(e.Graphics, e.Font, new Rectangle(e.Bounds.Left, e.Bounds.Top + 1, e.Bounds.Width, e.Bounds.Height), e.Index, DrawItemState.Default);
                        base.OnDrawItem(eNew);
            ...
            private Ctrl_CheckedComboBox ccbParent;
            ...
            public Cl_Dropdown(Ctrl_CheckedComboBox ccbParent)
            {
            ...
            public DashStyle p_SeparatorStyle {
                get { return m_SeparatorStyle; }
                set { m_SeparatorStyle = value; cclb.p_SeparatorStyle = value; }
            }

            [Description("Gets or sets the Separator Color"), Category("Separator")]
            public Color p_SeparatorColor {
                get { return m_SeparatorColor; }
                set { m_SeparatorColor = value; cclb.p_SeparatorColor = value; }
            }

            [Description("Gets or sets the Separator Width"), Category("Separator")]
            public int p_SeparatorWidth {
                get { return m_SeparatorWidth; }
                set { m_SeparatorWidth = value; cclb.p_SeparatorWidth = value; }
            }

            [Description("Gets or sets the Separator Margin"), Category("Separator")]
            public int p_SeparatorMargin {
                get { return m_SeparatorMargin; }
                set { m_SeparatorMargin = value; cclb.p_SeparatorMargin = value; }
            }
        ...
        public DashStyle p_SeparatorStyle {
            get { return m_SeparatorStyle; }
            set { m_SeparatorStyle = value; dropdown.p_SeparatorStyle = value; }
        }

        [Description("Gets or sets the Separator Color"), Category("Separator")]
        public Color p_SeparatorColor {
            get { return m_SeparatorColor; }
            set { m_SeparatorColor = value; dropdown.p_SeparatorColor = value; }
        }

        [Description("Gets or sets the Separator Width"), Category("Separator")]
        public int p_SeparatorWidth {
            get { return m_SeparatorWidth; }
            set { m_SeparatorWidth = value; dropdown.p_SeparatorWidth = value; }
        }

        [Description("Gets or sets the Separator Margin"), Category("Separator")]
        public int p_SeparatorMargin {
            get { return m_SeparatorMargin; }
            set { m_SeparatorMargin = value; dropdown.p_SeparatorMargin = value; }
        }
        ...
        public Ctrl_CheckedComboBox() : base()
        {
            ...
            this.dropdown = new Cl_Dropdown(this);
        ...
        protected override void OnDropDownClosed(EventArgs e)
        {
            ...
            if (e is Cl_Dropdown.CCBoxEventArgs)
            {
