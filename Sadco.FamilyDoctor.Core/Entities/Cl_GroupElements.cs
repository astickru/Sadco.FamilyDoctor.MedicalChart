...
{
    /// <summary>
    /// Класс сущности группы элементов
    /// </summary>
    [Table("T_GROUPS_ELEMENTS")]
	public class Cl_GroupElements : I_Group, I_Archive
    {
		public Cl_GroupElements() {
			p_SubGroups = new List<Cl_GroupElements>();
		}
        ...
        public Cl_GroupElements p_Parent { get; set; }

        /// <summary>Возвращает список вложенных групп</summary>
        [ForeignKey("p_ParentID")]
        public virtual ICollection<Cl_GroupElements> p_SubGroups { get; set; }
        ...
        public string f_GetParentName<T>(T parent) where T : I_Group {
			Cl_GroupElements parentObj = parent as Cl_GroupElements;
