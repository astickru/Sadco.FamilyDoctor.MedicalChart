namespace Sadco.FamilyDoctor.MedicalChart {
	partial class F_Main {
		...
		private void InitializeComponent() {
			...
			this.ctrl_CMTemplate.Size = new System.Drawing.Size(127, 26);
			// 
			// ctrl_MITemplateNew
			// 
			this.ctrl_MITemplateNew.Name = "ctrl_MITemplateNew";
			this.ctrl_MITemplateNew.Size = new System.Drawing.Size(126, 22);
			this.ctrl_MITemplateNew.Text = "Добавить";
			this.ctrl_MITemplateNew.Click += new System.EventHandler(this.ctrl_MITemplateNew_Click);
			// 
			// ctrl_PSearch
			// 
