...
namespace Sadco.FamilyDoctor.MedicalChart
{
    public static class UI_Helper
    {
        ...
        public static void AddTreeNodeControl(Cl_CtrlTemplateNode treeControl, TreeNodeCollection nodes, Cl_Element a_Element)
        {
            //treeControl.f_SetObjectControl(a_Element);
            treeControl.f_AddToTreeNode(nodes);
            //UI_Helper.SetMenuImage(a_Element.p_Icon, a_Element.p_IconName);
            treeControl.p_getTreeNode.ForeColor = Color.Blue;
            treeControl.p_getTreeNode.ImageKey = a_Element.p_IconName;
            treeControl.p_getTreeNode.SelectedImageKey = a_Element.p_IconName;
        }
